...
function Home(){
    ...
    const[bookNote,setBookNote]=useState<BookNoteType[]>([]);
    ...
    return (
        ...
        <div className="min-h-screen py-10 px-10 bg-black text-white">
          <div>
            ...
            {/* <h2 className='text-3xl font-bold t mb-4 text-green-400'>BOOKS I'VE READ</h2> */}
            {/* <p className="text-lg text-gray-400 mb-4">Tiny summary but detailed notes for each. Use the ISBN number to find it from your local library or anywhere else.
                 This page will constantly update as I read more, so bookmark it if you want to check back in a few months.</p>  */}
...
//               <h1 className="text-5xl font-extrabold text-white">Welcome to My Reading Journal</h1>
//               <button className="bg-gray-200 text-black font-bold py-2 px-6 rounded-lg shadow-md hover:bg-gray-300" onClick={handelCreatBook}>Create New Book</button>
//             </div>
//             <p className="mt-4 text-lg text-gray-300">Dive into my personal collection of books, with detailed notes and recommendations. Explore and get inspired!</p>
//           </div>

//           <h2 className='text-3xl font-bold mb-4 text-green-400'>BOOKS I'VE READ</h2>
//           <p className="text-lg text-gray-400 mb-4">Tiny summary but detailed notes for each. Use the ISBN number to find it from your local library or anywhere else.
//               This page will constantly update as I read more, so bookmark it if you want to check back in a few months.</p>
//           <p className="text-lg text-gray-400 mb-6">Sorted with my top recommendations up top. Sort by 
//               <span className="text-blue-400 cursor-pointer hover:underline" onClick={()=>{setIsShowNewestBooks(true)}}> newest
...
//           newestBooks.map(function(newestBooks){
//               return(
//                 <div className="flex items-start mb-8 border-b border-gray-700 pb-6 hover:bg-gray-800 p-4">
